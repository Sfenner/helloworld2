...
echo 'define command{
                          ...
                          command_line /usr/lib64/nagios/plugins/check_nrpe -H $HOSTADDRESSS$ -c $ARG1$
...
# Now take a break, and spin up a machine called example-a with all the nrpe plugins installed and a propperly configured path to nagios
